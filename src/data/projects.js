...
export const projects = [
	...
	},
	{
		...
		gallery: [
			{ src: WaitDashboardImg, size: "full" },
			{ src: WaitSearchImg, size: "half" },
			{ src: WaitAdminDashboardImg, size: "half" },
			{ src: WaitAdminUsersImg, size: "wide" },
			{ src: WaitPartnerImg, size: "narrow" },
			{ src: WaitRestaurantMenuImg, size: "half" },
			{ src: WaitRestaurantAddImg, size: "half" },
		],
	},
	{
		id: "snake",
